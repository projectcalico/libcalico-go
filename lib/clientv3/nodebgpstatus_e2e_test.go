...
var _ = testutils.E2eDatastoreDescribe("NodeBGPStatus tests", testutils.DatastoreAll, func(config apiconfig.CalicoAPIConfig) {
	...
	DescribeTable("NodeBGPStatus e2e CRUD tests",
		func(name1, name2 string, status1, status2 apiv3.NodeBGPStatusStatus) {
			...
			Expect(res1).To(MatchResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name1, nil, status1))
			...
			Expect(outError).NotTo(HaveOccurred())
			Expect(res).To(MatchResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name1, nil, status1))
			...
			Expect(outList.Items).To(ConsistOf(
				testutils.ResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name1, nil, status1),
			))
			...
			Expect(outError).NotTo(HaveOccurred())
			Expect(res2).To(MatchResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name2, nil, status2))
			...
			Expect(outList.Items).To(ConsistOf(
				testutils.ResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name1, nil, status1),
				testutils.ResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name2, nil, status2),
			))
			...
			Expect(outError).NotTo(HaveOccurred())
			Expect(res1).To(MatchResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name1, nil, status2))
			...
			Expect(outError).NotTo(HaveOccurred())
			Expect(res).To(MatchResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name1, nil, status2))
			...
			Expect(outError).NotTo(HaveOccurred())
			Expect(outList.Items).To(ConsistOf(
				testutils.ResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name1, nil, status2),
				testutils.ResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name2, nil, status2),
			))
			...
			Expect(outError).NotTo(HaveOccurred())
			Expect(dres).To(MatchResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name1, nil, status2))
			...
			if config.Spec.DatastoreType == apiconfig.Kubernetes {
				...
				Expect(outError).NotTo(HaveOccurred())
				Expect(dres).To(MatchResourceWithStatus(apiv3.KindNodeBGPStatus, testutils.ExpectNoNamespace, name2, nil, status2))
			}
