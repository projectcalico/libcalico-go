...
type FelixConfigurationSpec struct {
	...
	LogSeverityFile string `json:"logSeverityFile,omitempty" validate:"omitempty,felixLogLevel"`
	// LogSeverityScreen is the log severity above which logs are sent to the stdout. [Default: INFO]
	LogSeverityScreen string `json:"logSeverityScreen,omitempty" validate:"omitempty,felixLogLevel"`
	// LogSeveritySys is the log severity above which logs are sent to the syslog. Set to NONE for no logging to syslog.
	// [Default: INFO]
	LogSeveritySys string `json:"logSeveritySys,omitempty" validate:"omitempty,felixLogLevel"`
