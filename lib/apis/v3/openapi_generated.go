			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"bpfExtToServiceConnmark": {
						SchemaProps: spec.SchemaProps{
							Description: "BPFExtToServiceConnmark in BPF mode, control a 32bit mark that is set on connections from an external client to a local service. This mark allows us to control how packets of that connection are routed within the host and how is routing intepreted by RPF check.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
