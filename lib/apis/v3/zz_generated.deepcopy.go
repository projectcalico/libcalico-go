...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlobalNetworkSetStatus) DeepCopyInto(out *GlobalNetworkSetStatus) {
	*out = *in
	if in.IPs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalNetworkSetStatus.
func (in *GlobalNetworkSetStatus) DeepCopy() *GlobalNetworkSetStatus {
	if in == nil {
		return nil
	}
	out := new(GlobalNetworkSetStatus)
	in.DeepCopyInto(out)
	return out
}
