...
var _ = Describe("Test Node conversion", func() {
	...
	It("Should merge Calico Nodes into K8s Nodes", func() {
		...
		calicoNodeWithMergedLabels.Spec.Addresses = []apiv3.NodeAddress{
			{Type: apiv3.NodeAddressIP, Address: "172.17.17.10/24"},
			{Type: apiv3.NodeAddressIP, Address: "aa:bb:cc::ffff/120"},
		}
	...
	It("should parse addresses of all types into Calico Node", func() {
		...
		addrs := n.Value.(*apiv3.Node).Spec.Addresses
		Expect(addrs).To(ConsistOf([]apiv3.NodeAddress{
			{Type: apiv3.NodeAddressIP, Address: "fd10::10"},
			{Type: apiv3.NodeAddressK8sInternalIP, Address: "172.17.17.10"},
			...
			{Type: apiv3.NodeAddressK8sExternalIP, Address: "192.168.1.100"},
		}))
	})
})
