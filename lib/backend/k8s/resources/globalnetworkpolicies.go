...
func (c GlobalNetworkPolicyConverter) ToKVPair(r K8sResource) (*model.KVPair, error) {
...
func (c GlobalNetworkPolicyConverter) FromKVPair(kvp *model.KVPair) (K8sResource, error) {
